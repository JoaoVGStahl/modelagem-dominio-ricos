...
using PontoSysStore.Vendas.Application.Queries.ViewModels;
using System;
...
namespace PontoSysStore.WebApp.Mvc.Controllers
{
    public class CarrinhoController : ControllerBase
    {
        ...
        public CarrinhoController(INotificationHandler<DomainNotification> notifications, IProdutoAppService produtoAppService, IMediatrHandler mediatrHandler, IPedidoQueries pedidoQueries) : base(notifications, mediatrHandler)
        {
        ...
        public async Task<IActionResult> IniciarPedido(CarrinhoViewModel carrinhoViewModel)
        {
            ...
            var command = new IniciarPedidoCommand(carrinho.PedidoId, ClienteId, carrinho.ValorTotal, carrinhoViewModel.Pagamento.NomeCartao,
                carrinhoViewModel.Pagamento.NumeroCartao, carrinhoViewModel.Pagamento.DataExpiracao, carrinhoViewModel.Pagamento.CvvCartao);
