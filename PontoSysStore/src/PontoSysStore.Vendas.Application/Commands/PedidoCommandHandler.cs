...
using PontoSysStore.Core.Extensions;
...
namespace PontoSysStore.Vendas.Application.Commands
{
    public class PedidoCommandHandler : 
        ...
        IRequestHandler<CancelProcessamentoPedidoCommand, bool>
    {
        ...
        //CancelarProcessamentoPedidoEstornarEstoqueCommand
        ...
        //CancelProcessamentoPedidoCommand
        public async Task<bool> Handle(CancelProcessamentoPedidoCommand message, CancellationToken cancellationToken)
        {
            var pedido = await _pedidoRepository.ObterPorId(message.PedidoId);
